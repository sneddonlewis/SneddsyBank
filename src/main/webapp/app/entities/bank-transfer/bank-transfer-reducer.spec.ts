...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTRANSFER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTRANSFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTRANSFER actions', async () => {
      const expectedActions = [
        {
